...
<
    ...
    Foam::volMesh
>>
Foam::taylorIsoSurface::adaptPatchFields
(
...
template<class Type>
Type Foam::taylorIsoSurface::generatePoint
(
    const scalar s0,
    const Type& p0,
    const bool hasSnap0,
...
template<class Type>
void Foam::taylorIsoSurface::generateTriPoints
(
    const scalar s0,
    const Type& p0,
    const bool hasSnap0,
...
template<class Type>
Foam::label Foam::taylorIsoSurface::generateFaceTriPoints
(
...
Foam::taylorIsoSurface::interpolate
(
    const label nPoints,
