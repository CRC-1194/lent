...
Class
    Foam::constantCurvatureModel

SourceFiles
    constantCurvatureModelI.H
    constantCurvatureModel.C
    constantCurvatureModelIO.C
...
namespace FrontTracking {
    ...
    defineTypeNameAndDebug(constantCurvatureModel, 0);
    addToRunTimeSelectionTable(curvatureModel, constantCurvatureModel, Dictionary);
